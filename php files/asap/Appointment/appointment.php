...
try {
    ...
    //Body content
    $body = "<b>Message From:</b>". $name."<br><b>Phone:</b>".$phone."<br><b>E-mail:</b>".$email."<br><b>Device-Type:</b>".$device."<br><b>Time:</b>".$time."<br><b>Date:</b>". $date."<br><br><b>Message:</b>". $message;
